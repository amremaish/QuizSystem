  ...
  Selectpicker.prototype = {
    ...
    setSelected: function (liData, selected) {
      ...
      var li = liData.element,
          ...
          //  - when retainActive is false when selecting a new option (i.e. web of the newly selected option is not the same as the current activeElement)
    ...
    /**
     * @param {number} web - the web of the option that is being disabled
